<div class="coupons index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('start day'); ?></th>
			<th><?php echo $this->Paginator->sort('end day'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($coupon['Coupon']['start day']); ?>&nbsp;</td>
		<td><?php echo h($coupon['Coupon']['end day']); ?>&nbsp;</td>
